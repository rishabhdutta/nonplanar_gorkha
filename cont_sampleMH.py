...
varname1 = 'samples1/stage11/resampstage.mat'
...
resmplpost = mat_samplestage['resmplpost']
...
samples = NT2(samplestage, postval, beta[-1], stage[-1], covsmpl, resmpl, resmplpost)

current = SMCclass(opt, samples, NT1, NT2)
samples = current.MCMC_samples_part() 

varnamepart = 'samples1/stage11/samples/sample11stage'
varname2 = varnamepart + np.str(indarray)+ '.mat'    
